#!/usr/bin/env python3
"""
Batch Processor - Process multiple sheets with one command

Usage:
    python -m temple_lighting.batch

Processes sheets defined in batch_config.json.
"""
...
from temple_lighting.automation import TempleWorkflow
